...
namespace Engine
{
    ...
    public class Location
    {
        ...
        public Monster NewInstanceOfMonsterLivingHere()
        {
            ...
            // Select a random number between 1 and the total (in case the total percetnages are > 100)
            int randomNumber = RandomNumberGenerator.NumberBetween(1, totalPercentages);

            // Loop through the monster list, adding the monster's percentage chance of appearing to the runningTotal ...
