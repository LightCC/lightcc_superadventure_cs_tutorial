...
namespace Engine
{
    ...
    {
        public static Player CreatePlayerFromXmlFile(string FileName)
        {
            var xmlString = File.ReadAllText(FileName);
            var player = CreatePlayerFromXmlString(xmlString);
            return player;
        }
        ...
        public static Player CreatePlayerFromXmlString(string xmlPlayerData)
        {
            try
            {
                ...
                var player = new Player(currentHitPoints, maximumHitPoints, gold, experiencePoints, currentLocationID);
                ...
                // If we got all the way through, then there isn't an issue, so set the _initSource and return the player
                player.InitSource = InitType.FromXmlFile;
                return player;
            }
            catch
            {
